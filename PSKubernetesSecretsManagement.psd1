...
@{
    ...
    FunctionsToExport    = 'Get-KubernetesSecretData', 'New-KubernetesEphemeralSecret', 'Set-KubernetesSecretValue', 'Get-KubernetesNamespaceMetadata'

    # Aliases to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no aliases to export.
    AliasesToExport      = 'gksd', 'nkes', 'sksv', 'gknm'
